...
**Setting up for your team?** Go to [Configure Your Application](/configure-your-application) → [Integrate With CI/CD](/integrate-with-cicd)
...
**Never used Autonoma?** → [Your First Test](/your-first-test)

**Setting up for your team?** → [Configure Your Application](/configure-your-application)

**Want the big picture first?** → [What is e2e Testing](/what-is-e2e-testing)

**Building complex tests?** → [Advanced Testing Techniques](/clicking-vs-prompting)
