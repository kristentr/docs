...
- [GitHub Actions](#github-actions): Best for teams using GitHub for version control
- [GitLab CI](#gitlab-ci): Best for teams using GitLab for version control
- [Bitbucket Pipelines](#bitbucket-pipelines): Best for teams using Bitbucket for version control
- [cURL (Universal)](#curl-universal): Works with any CI/CD system—Jenkins, CircleCI, Travis, etc.
...
#### Step 1: Add Credentials to GitLab CI/CD Variables
...
#### Step 1: Add Credentials to Bitbucket Variables
