...
![Screenshot showing how to get cURL command for a folder](/Screenshot2025-02-16at7.28.43PM.png)

For a single test its similar, go to a test, click over the three dots and select the cURL command option.

![Screenshot showing how to get cURL command for a test](/Screenshot2025-02-16at7.29.11PM.png)
