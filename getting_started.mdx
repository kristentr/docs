...
- **Goal**: Validate that users can navigate from Google's Home to Google Maps.
- **Steps**: Click on 'Stay signed out', click on the upper right menu app selector, click on the Google Maps app option.
- **Asserts**: Validate that we see the Google Maps map.

![Demo Ecommerce Gi](https://cdn.autonoma.app/images/getting-started.gif)