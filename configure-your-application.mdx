...
- [Email and Password](#email-and-password): Most common authentication method with username/password
- [Magic Link](#magic-link): Passwordless authentication via email links
- [Header or Cookie Bypass](#header-or-cookie-bypass): Fastest method requiring development team support
- [IP Whitelisting](#ip-whitelisting): Additional security layer for restricting access
...
*Ready to automate your test execution? Continue to [Integrate With CI/CD →](/cicd_integration)*
